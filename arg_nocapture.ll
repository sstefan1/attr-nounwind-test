...
; }
;
; CHECK: define void @test_var_arg_call(i8* %p, i32 %a)
define void @test_var_arg_call(i8* nocapture %p, i32 %a) #0 {
entry:
...
;
; There should *not* be a no-capture attribute on %a
; CHECK: define void @negative_test_not_captured_but_returned_call_1a(i64* returned %a)
